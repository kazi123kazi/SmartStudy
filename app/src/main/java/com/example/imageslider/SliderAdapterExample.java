...
public class SliderAdapterExample extends
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        switch (position) {
            case 0:
               viewHolder.textViewDescription.setText("Books");
...
//                        .into(viewHolder.imageViewBackground);
            ...
            case 2:
                ...
                viewHolder.textViewDescription.setText("Resources " );
//                viewHolder.textViewDescription.setTextSize(16);
//                viewHolder.textViewDescription.setTextColor(Color.WHITE);
//                viewHolder.imageGifContainer.setVisibility(View.GONE);
//                Glide.with(viewHolder.itemView)
...
//                        .into(viewHolder.imageViewBackground);
            ...
            case 4:
                ...
                viewHolder.textViewDescription.setText("Online Video Lecture" );
//                viewHolder.textViewDescription.setTextSize(16);
//                viewHolder.textViewDescription.setTextColor(Color.WHITE);
//                viewHolder.imageGifContainer.setVisibility(View.GONE);
//                Glide.with(viewHolder.itemView)
...
//                viewHolder.textViewDescription.setTextColor(Color.WHITE);
               viewHolder.textViewDescription.setText("Practise & Test");
